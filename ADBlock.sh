### 手机去广告
# wget --no-check-certificate https://raw.fastgit.org/StevenBlack/hosts/master/hosts -O - |sed 's/^0.0.0.0 /127.0.0.1 /g' |grep 127.0.0.1 >/tmp/hosts
# wget --no-check-certificate https://raw.gitmirror.com/notracking/hosts-blocklists/master/dnsmasq/dnsmasq.blacklist.txt -O - \
#   | sed 's/address=\//127.0.0.1 /g' |sed 's/\/#//g' |grep "^127.0.0.1 "  >>/tmp/hosts
...
[Rule]
DOMAIN-SUFFIX,openai.com,🇺🇸 [V1] 美国・05
DOMAIN-SUFFIX,chatgpt.com,🇺🇸 [V1] 美国・05
DOMAIN-SUFFIX,openaiapi-site.azureedge.net,🇺🇸 [V1] 美国・05
DOMAIN-SUFFIX,sentry.io,🇺🇸 [V1] 美国・05
DOMAIN-SUFFIX,segment.io,🇺🇸 [V1] 美国・05
DOMAIN-SUFFIX,bing.com,PROXY
DOMAIN-SUFFIX,huggingface.co,PROXY
DOMAIN-SUFFIX,zbook.lol,PROXY
DOMAIN-SUFFIX,missav.com,PROXY
DOMAIN-SUFFIX,mtalk.google.com,🇺🇸 [V1] 美国・05
DOMAIN-SUFFIX,bard.google.com,🇺🇸 [V1] 美国・05
DOMAIN-SUFFIX,claude.ai,🇺🇸 [V1] 美国・05
...
DOMAIN-SUFFIX,anws.gov.tw,PROXY
...
DOMAIN-SUFFIX,homeip.net,PROXY
...
DOMAIN-SUFFIX,levyhsu.com,PROXY
...
DOMAIN-SUFFIX,nesnode.com,PROXY
...
DOMAIN-SUFFIX,newsmagazine.asia,PROXY
...
DOMAIN-SUFFIX,olabloga.pl,PROXY
...
DOMAIN-SUFFIX,pussthecat.org,PROXY
...
DOMAIN-SUFFIX,raxcdn.com,PROXY
